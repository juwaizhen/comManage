	...
	<div class="layui-card bgBorder minHeight440" name="billListDiv" id="billListDiv">
		...
		<script type="text/html" id="barDemo">
			<div class="layui-btn-container">
				<a lay-event="detail" class="a_oper_blue layui-icon layui-icon-list mr10" title="详情"></a>
				<a lay-event="edit" class="a_oper_blue layui-icon layui-icon-edit mr10" title="修改"></a>
				<a lay-event="del" class="a_oper_red layui-icon layui-icon-delete" title="删除"></a>
			</div>
		</script>
